                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">اسم المنتوج</label>
                                                <input type="text" class="form-control text-light" name="titre"
                                                    value="{{ $produit->titre }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">الكمية</label>
                                                <input type="text" class="form-control text-light" name="quantite"
                                                    value="{{ $produit->quantite }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">سعر البيع</label>
                                                <input type="text" class="form-control text-light" name="prix_vente"
                                                    value="{{ $produit->prix_vente }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">سعر ادنى</label>
                                                <input type="text" class="form-control text-light" name="prix_minimal"
                                                    value="{{ $produit->prix_minimal }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label"> النوع</label>
                                                <input type="text" class="form-control text-light" name="type"
                                                    value="{{ $produit->type }}" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">الوصف</label>
                                                <textarea type="date" class="form-control text-light" name="description" rows="5"
                                                    readonly>{{ $produit->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
