    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">لائحة الزبناء </a></li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">الاسم الزبون الكامل</label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea type="date" class="form-control" name="adresse">{{ $client->adresse }}</textarea>
                                                </div>
                                            </div>
                ...
                @foreach ($clients as $client)
                    <!-- Modal remove -->
                    <div class="modal fade" id="client-remove-{{ $client->id }}">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <label class="form-label">الاسم الزبون</label>
